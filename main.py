...
CORS(app, origins=["https://gprotect-frontend.vercel.app/","https://gprotect-frontend.vercel.app/dashboard"],supports_credentials=True,methods=['GET','POST','PUT','DELETE','OPTIONS'])
